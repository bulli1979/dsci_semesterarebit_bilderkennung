"""
Training-Script für Standard Modell (Transfer Learning)
"""
...
def train_standard(
    ...
    model_name: str = "model_Werkzeuge",
    epochs: int = 200,
    patience: int = 100,
    fine_tune: bool = True,
    ...
    """
    Trainiert ein Standard Transfer Learning Modell basierend auf MobileNetV2.
